...
<body>
    ...
    <table style="width: 700px;">
        <tr>
            ...
            <td style="width:80%">
                <input type="text" style="width:200px;max-width: 150px;" name="member_id" id="member_id" value="<%=member_id%>" readonly>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="password" style="width:200px;max-width: 150px;" name="member_pwd" id="member_pwd" value="<%=member_pwd%>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="text" style="width:200px;max-width: 150px;" name="member_name" id="member_name" value="<%=member_name%>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="number" style="width:200px;max-width: 150px;" name="member_birth" id="member_birth" value="<%=member_birth%>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="number" style="width:200px;max-width: 150px;" name="member_phone" id="member_phone" value="<%=member_phone%>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="number" style="width:200px;max-width: 100px;" name="zipcode" id="zipcode" value="<%=zipcode%>">
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="text" style="width:300px;max-width: 250px;" name="jaddress" id="jaddress" placeholder="지번주소" value="<%=jaddress%>">
            </td>
        </tr>

        <tr>
            <td style="width:80%">
                <input type="text" style="width:300px;max-width: 250px;" name="raddress" id="raddress" placeholder="도로명 주소" value="<%=raddress%>">
            </td>
        </tr>

        <tr>
            <td style="width:80%">
                <input type="text" style="width:300px;max-width: 250px;" name="address" id="address" placeholder="상세주소" value="<%=address%>">
            </td>
        </tr>
    ...
    <button type="button" onclick="send_list();">회원리스트</button>
...
<script>
    ...
    function send_modify(){
        ...
        if(ans){
            obj.action="/web_project2/MemberModifyServlet";
            obj.submit();
        }else{
        	return false;
        }
