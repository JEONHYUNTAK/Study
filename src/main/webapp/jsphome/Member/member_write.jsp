...
<body>
    ...
    <div class="container px-4 px-lg-5">
	    ...
	    <button type="button" class="btn btn-success btn-sm" onclick="reset();">새로작성</button>
	    <button type="button" class="btn btn-success btn-sm" onclick="send_list();">회원리스트</button>
...
<script>
    ...
    function send_write(){
        ...
        obj.action="/web_project2/MemberWriteServlet";
        obj.submit();
